...
class TestFriends < MiniTest::Test
  ...
  # (e.g. the function favourite_tv_show(@person2) should return the string "Baywatch")
   ...
   def test_find_name_from_tv
     result = get_name_from_tv(@person2)
  ...
  def test_likes_to_eat
      result = get_boolean_from_food(@person4, "spaghetti")
  ...
  def test_number_of_friends
    # p @people.length()
    add_friend(@person6, "Scrappy-Doo")
  ...
  # (hint: Same as above, testing for the length of the array should be sufficient)
    ...
    def test_number_of_friends__remove
  ...
  # (hint2: You should test if both the lender's and the lendee's money have changed, maybe two assertions?)
    ...
    def test_money_recieved
          lend_money(@person5, @person2, 20)
            result = @person2[:monies]
